    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                <form id="edit_category_form" class="form d-flex flex-column flex-lg-row"
                    data-kt-redirect="{{ route('admin.categories.index') }}"
                    action="{{ route('admin.categories.update', $category->id) }}" method="PUT"
                            ...
                            <div class="card-body text-center pt-0">
                                ...
                                <div class="image-input image-input-outline image-input-placeholder mb-3"
                                    ...
                                    <div class="image-input-wrapper w-150px h-150px"
                                        style="background-image: url({{ asset('images/categories/' . $category->icon) }})">
                                    </div>
                                ...
                                <select name="category_id" class="form-select" data-control="select2"
                                    ...
                                    @foreach ($categories as $parent)
                                        <option value="{{ $parent->id }}"
                                            {{ $category->category_id == $parent->id ? 'selected' : '' }}>
                                            {{ $parent->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Editor-->
                                    <div id="description" name="description" class="min-h-200px mb-2">
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Editor-->
                                    <div id="information" name="information" class="min-h-200px mb-2">
...
@section('scripts')
    ...
    <script>
        ...
        const CategoriesForm = function() {
            // Base elements
            const formEl = $('#edit_category_form');
            ...
            const _initRepeater = function() {
                const repeater = $('#features').repeater({
                    initEmpty: false,

        ...
        <div class="page-header-ui-content pt-10">
            <div class="container text-center">
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <h1 class="page-header-ui-title">IP Address Lookup</h1>
                        <p class="lead">Search any IP Address</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row features text-center mb-10">
                ...
                <div
                    ...
                    <div class="card-block" style="text-align: center;">
                        ...
                        <div class="gx-5 mt-2" id="result_lookup">
                        ...
                        <div class="row" id="input_ip">
                            <div class="col-12 mb-4 overflow-hidden">
                                <form class="form-group" style="padding: 10px;" action="{{ route('getIpLookup') }}"
                                    id="form_ip" method="POST">
...
@section('scripts')
    ...
    <script>
        "use strict";
        // Class definition
        const formEl = $('#form_ip');
        const resultEl = $('#result_lookup');
        const inputEl = $('#input_ip');
        resultEl.hide();

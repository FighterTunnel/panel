        ...
        <div class="page-header-ui-content pt-10">
            <div class="container text-center">
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <h1 class="page-header-ui-title">Check Server Status</h1>
                        <p class="lead">The servers listed below are still not reached daily limit account.
                            You can check server status here and go to the servers page and create new
                            Account</p>
                    </div>
                </div>
            </div>
                    ...
                    <tbody>
                        @foreach ($servers as $server)
                            <tr>
                                ...
                                <td>
                                    @if ($server->limit - $server->current == 0)
                                        <span class="badge bg-danger">Full</span>
                                    @else
                                        <span class="badge bg-success">{{ $server->limit - $server->current }}
                                        </span>
                                    @endif
                                </td>
                            </tr>
        ...
        <div class="container px-5">
            <div class="row gx-5 align-items-center justify-content-center">
                <div class="col-md-9 col-lg-6 order-1 order-lg-0" data-aos="fade-right">
                    <div class="mb-5">
                        <h2 class="mb-3">Account Remaining</h2>
                        <p class="small">

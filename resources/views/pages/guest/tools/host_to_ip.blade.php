        ...
        <div class="page-header-ui-content pt-10">
            <div class="container text-center">
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <h1 class="page-header-ui-title">Host To IP</h1>
                        <p class="lead">Convert Hostname to Ip Address.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="bg-white py-10">
        <div class="container px-5">
            <div class="row features text-center mb-10">
                ...
                <div
                    class="col-12 col-lg-4 mb-2 py-2 px-2 text-center card card-link border-top border-top-lg border-teal h-100">
                    <div class="card-block" style="text-align: center;">
                        ...
                        <div class="gx-5 mt-2" id="result_host">
                        ...
                        <div class="row" id="input_host">
                            <div class="col-12 mb-4 overflow-hidden">
                                <form class="form-group" id="form_hostname" style="padding: 10px;"
                                    action="{{ route('hostToIP') }}" method="POST">
                                    <input type="text" name="host" class="form-control" placeholder="www.example.com">
                                    <p class="mt-2" style="font-size: 14px;font-weight: bold;color: #999;">
                                        Put Domain or Hostname without http://, ex: google.com, facebook.com, etc.
                                    </p>
                ...
                <div class="col-12 mt-5">
                    <h3>What is host?</h3>A network host is a computer or other device connected to a computer
                    network. A network
                    host may offer information resources, services, and applications to users or other nodes on the
                    network. A
                    network host is a network node that is assigned a network layer host address.</p>
                    <p>Computers participating in networks that use the Internet Protocol Suite may also be called
                        IP hosts.
                        Specifically, computers participating in the Internet are called Internet hosts, sometimes
                        Internet nodes.
                        Internet hosts and other IP hosts have one or more IP addresses assigned to their network
                        interfaces. The
                        addresses are configured either manually by an administrator, automatically at start-up by
                        means of the
                        Dynamic Host Configuration Protocol (DHCP), or by stateless address autoconfiguration
                        methods.</p>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-md-9 col-lg-6 order-1 order-lg-0" data-aos="fade-right">
                    <div class="mb-5">
                        <h2 class="mb-3">Convert Hostname To Numberic Ip Address</h2>
                        <p class="small">
                            In computer networking, a hostname is a label that is assigned to a device
                            connected to a
                            computer network and that is used to identify the device in various forms of
                            electronic
                            communication, such as the World Wide Web. Hostnames may be simple names
                            consisting of a single
                            word or phrase, or they may be structured.
                        </p>
                        <p class="small">
                            ...
                            address serves
                            two main functions: host or network interface identification and location
                            addressing.
                        </p>
                        <p class="small">Keywords: host to ip </p>
                    </div>
                </div>
...
@section('scripts')
    ...
    <script>
        ...
        const btn = document.querySelector('[data-element="copy"]');

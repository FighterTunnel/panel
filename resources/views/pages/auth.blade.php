...
<body id="kt_body" class="bg-body">
                    ...
                    <form class="form w-100" novalidate="novalidate" id="form_login">
                        ...
                        <div class="fv-row mb-10">
                            ...
                            <input class="form-control form-control-lg form-control-solid" type="text" id="username"
                                name="username" autocomplete="off" data-login="1" />
                        </div>
                        <div class="fv-row mb-10">
                        ...
                        <div class="text-center">
                            <button id="tombol_login"
                                onclick="handle_post('#tombol_login','#form_login','{{ route('admin.do_login') }}');"
    ...
    <script src="{{ asset('admins/plugins/global/plugins.bundle.js') }}" type="text/javascript"></script>
    <script src="{{ asset('admins/js/scripts.bundle.js') }}" type="text/javascript"></script>
